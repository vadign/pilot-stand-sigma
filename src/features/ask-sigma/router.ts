...
const entityKeywords: Record<AskSigmaEntity, string[]> = {
  ...
  briefing: ['отчет', '24 часа'],
  map: ['карта', 'на карте', 'координат'],
  transport: ['транспорт', 'общественный транспорт', 'остановк', 'маршрут', 'маршрутк', 'автобус', 'троллейбус', 'трамва', 'метро', 'павильон', 'проезд', 'тариф', 'пересадк', 'узел', 'как проехать', 'как добраться'],
  sources: ['источник', 'источники данных', 'статус источников', 'когда обновлялись', 'обновлялись данные', 'freshness'],
