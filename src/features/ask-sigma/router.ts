...
const entityKeywords: Record<AskSigmaEntity, string[]> = {
  ...
  ecology: ['эколог', 'воздух', 'aqi', 'pm2.5', 'pm10', 'погод', 'смог'],
  transport: ['транспорт', 'остановк', 'маршрут', 'пробк', 'нагрузка на дороги'],
  medical: ['больниц', 'поликлиник', 'медучрежден'],
  directory: ['школ', 'детсад', 'библиотек', 'аптек', 'парковк', 'культур', 'спорт'],
  safety: ['камер', 'видеофиксац', 'контрол'],
